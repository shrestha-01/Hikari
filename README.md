...
I am trying to combine all the available **free APIs** and use them as a **fallback system**.

For example, the API system currently works something like this [For Anime]:
